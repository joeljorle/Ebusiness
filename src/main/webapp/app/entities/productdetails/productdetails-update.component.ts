...
export class ProductdetailsUpdateComponent implements OnInit {
  ...
  updateForm(productdetails: IProductdetails): void {
    this.editForm.patchValue({
      ...
      availableat: productdetails.availableat != null ? productdetails.availableat.format(DATE_TIME_FORMAT) : null,
      lockactiondelay: productdetails.lockactiondelay != null ? productdetails.lockactiondelay.format(DATE_TIME_FORMAT) : null,
      lockaction: productdetails.lockaction,
      expireat: productdetails.expireat != null ? productdetails.expireat.format(DATE_TIME_FORMAT) : null
    });
  }
  ...
  private createFromForm(): IProductdetails {
    return {
      ...
      availableat:
        this.editForm.get(['availableat'])!.value != null ? moment(this.editForm.get(['availableat'])!.value, DATE_TIME_FORMAT) : undefined,
      lockactiondelay:
        this.editForm.get(['lockactiondelay'])!.value != null
