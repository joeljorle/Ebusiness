...
export class CategorydetailsUpdateComponent implements OnInit {
  ...
  updateForm(categorydetails: ICategorydetails): void {
    this.editForm.patchValue({
      ...
      generalhiddendelay: categorydetails.generalhiddendelay != null ? categorydetails.generalhiddendelay.format(DATE_TIME_FORMAT) : null,
      generallock: categorydetails.generallock,
      generallockdelay: categorydetails.generallockdelay != null ? categorydetails.generallockdelay.format(DATE_TIME_FORMAT) : null,
      generalexpire: categorydetails.generalexpire,
      generalexpiredelay: categorydetails.generalexpiredelay != null ? categorydetails.generalexpiredelay.format(DATE_TIME_FORMAT) : null,
