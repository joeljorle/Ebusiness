...
export class TourcategoryUpdateComponent implements OnInit {
  ...
  updateForm(tourcategory: ITourcategory): void {
    this.editForm.patchValue({
      ...
      lockdelay: tourcategory.lockdelay != null ? tourcategory.lockdelay.format(DATE_TIME_FORMAT) : null,
      ...
      createdat: tourcategory.createdat != null ? tourcategory.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: tourcategory.updatedat != null ? tourcategory.updatedat.format(DATE_TIME_FORMAT) : null,
