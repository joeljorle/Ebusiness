...
export class RatingsUpdateComponent implements OnInit {
  ...
  updateForm(ratings: IRatings): void {
    this.editForm.patchValue({
      ...
      value: ratings.value,
      createdat: ratings.createdat != null ? ratings.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: ratings.updatedat != null ? ratings.updatedat.format(DATE_TIME_FORMAT) : null,
      categoryId: ratings.categoryId,
      productId: ratings.productId,
      evenementId: ratings.evenementId
    });
