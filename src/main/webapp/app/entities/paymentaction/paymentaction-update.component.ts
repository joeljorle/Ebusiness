...
export class PaymentactionUpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.data.subscribe(({ paymentaction }) => {
      if (!paymentaction.id) {
        ...
        paymentaction.expireat = today;
        paymentaction.createdat = today;
        paymentaction.updatedat = today;
      }
  ...
  updateForm(paymentaction: IPaymentaction): void {
    this.editForm.patchValue({
      ...
      expireat: paymentaction.expireat ? paymentaction.expireat.format(DATE_TIME_FORMAT) : null,
      code: paymentaction.code,
      code1: paymentaction.code1,
      code2: paymentaction.code2,
      amount: paymentaction.amount,
      createdat: paymentaction.createdat ? paymentaction.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: paymentaction.updatedat ? paymentaction.updatedat.format(DATE_TIME_FORMAT) : null,
      productId: paymentaction.productId,
      evenementId: paymentaction.evenementId,
      paymentmethodId: paymentaction.paymentmethodId
    });
