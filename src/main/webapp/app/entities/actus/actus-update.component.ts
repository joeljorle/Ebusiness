...
export class ActusUpdateComponent implements OnInit {
  ...
  updateForm(actus: IActus): void {
    this.editForm.patchValue({
      ...
      createdat: actus.createdat != null ? actus.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: actus.updatedat != null ? actus.updatedat.format(DATE_TIME_FORMAT) : null
    });
  }
