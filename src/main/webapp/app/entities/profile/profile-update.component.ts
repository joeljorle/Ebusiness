...
export class ProfileUpdateComponent implements OnInit {
  ...
  updateForm(profile: IProfile): void {
    this.editForm.patchValue({
      ...
      lockdelay: profile.lockdelay != null ? profile.lockdelay.format(DATE_TIME_FORMAT) : null,
      about: profile.about,
      ...
      createdat: profile.createdat != null ? profile.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: profile.updatedat != null ? profile.updatedat.format(DATE_TIME_FORMAT) : null,
      userId: profile.userId,
