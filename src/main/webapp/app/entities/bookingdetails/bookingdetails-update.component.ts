...
export class BookingdetailsUpdateComponent implements OnInit {
  ...
  updateForm(bookingdetails: IBookingdetails): void {
    this.editForm.patchValue({
      ...
      startdate: bookingdetails.startdate != null ? bookingdetails.startdate.format(DATE_TIME_FORMAT) : null,
      enddate: bookingdetails.enddate != null ? bookingdetails.enddate.format(DATE_TIME_FORMAT) : null,
