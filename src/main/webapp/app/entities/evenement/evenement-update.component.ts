...
export class EvenementUpdateComponent implements OnInit {
  ...
  updateForm(evenement: IEvenement): void {
    this.editForm.patchValue({
      ...
      lockdelay: evenement.lockdelay != null ? evenement.lockdelay.format(DATE_TIME_FORMAT) : null,
      islimited: evenement.islimited,
      limiteddelay: evenement.limiteddelay != null ? evenement.limiteddelay.format(DATE_TIME_FORMAT) : null,
      limitedbooking: evenement.limitedbooking,
      startdate: evenement.startdate != null ? evenement.startdate.format(DATE_TIME_FORMAT) : null,
      enddate: evenement.enddate != null ? evenement.enddate.format(DATE_TIME_FORMAT) : null,
      ...
      createdat: evenement.createdat != null ? evenement.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: evenement.updatedat != null ? evenement.updatedat.format(DATE_TIME_FORMAT) : null,
  ...
  private createFromForm(): IEvenement {
    return {
      ...
      limiteddelay:
        this.editForm.get(['limiteddelay'])!.value != null
