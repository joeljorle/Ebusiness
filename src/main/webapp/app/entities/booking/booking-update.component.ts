...
export class BookingUpdateComponent implements OnInit {
        ...
        .subscribe((resBody: IBookingview[]) => {
          if (!booking.bookingviewId) {
            ...
            this.bookingviewService
              ...
              .subscribe((concatRes: IBookingview[]) => {
                this.bookingviews = concatRes;
              });
          }
        });
        ...
        .subscribe((resBody: IBookingdetails[]) => {
          if (!booking.bookingdetailsId) {
            ...
            this.bookingdetailsService
              ...
              .subscribe((concatRes: IBookingdetails[]) => {
                this.bookingdetails = concatRes;
              });
          }
        });
  ...
  updateForm(booking: IBooking): void {
    this.editForm.patchValue({
      ...
      createdat: booking.createdat != null ? booking.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: booking.updatedat != null ? booking.updatedat.format(DATE_TIME_FORMAT) : null,
