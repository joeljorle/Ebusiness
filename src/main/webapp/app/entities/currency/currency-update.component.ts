...
export class CurrencyUpdateComponent implements OnInit {
  ...
  updateForm(currency: ICurrency): void {
    this.editForm.patchValue({
      ...
      createdat: currency.createdat != null ? currency.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: currency.updatedat != null ? currency.updatedat.format(DATE_TIME_FORMAT) : null,
