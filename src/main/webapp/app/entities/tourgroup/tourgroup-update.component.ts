...
export class TourgroupUpdateComponent implements OnInit {
  ...
  updateForm(tourgroup: ITourgroup): void {
    this.editForm.patchValue({
      ...
      lockdelay: tourgroup.lockdelay != null ? tourgroup.lockdelay.format(DATE_TIME_FORMAT) : null,
      ...
      createdat: tourgroup.createdat != null ? tourgroup.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: tourgroup.updatedat != null ? tourgroup.updatedat.format(DATE_TIME_FORMAT) : null,
