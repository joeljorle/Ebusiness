...
export class TourUpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.data.subscribe(({ tour }) => {
      if (!tour.id) {
        ...
        tour.lockdelay = today;
        tour.createdat = today;
        tour.updatedat = today;
      }
  ...
  updateForm(tour: ITour): void {
    this.editForm.patchValue({
      ...
      name: tour.name,
      islock: tour.islock,
      lockdelay: tour.lockdelay ? tour.lockdelay.format(DATE_TIME_FORMAT) : null,
      about: tour.about,
      title: tour.title,
      tag: tour.tag,
      ...
      createdat: tour.createdat ? tour.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: tour.updatedat ? tour.updatedat.format(DATE_TIME_FORMAT) : null,
