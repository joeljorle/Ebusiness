...
export class CategoryUpdateComponent implements OnInit {
        ...
        .subscribe((resBody: ICategorydetails[]) => {
          if (!category.categorydetailsId) {
            ...
            this.categorydetailsService
              ...
              .subscribe((concatRes: ICategorydetails[]) => (this.categorydetails = concatRes));
          }
        });
  ...
  updateForm(category: ICategory): void {
    this.editForm.patchValue({
      ...
      lockdelay: category.lockdelay ? category.lockdelay.format(DATE_TIME_FORMAT) : null,
      type: category.type,
