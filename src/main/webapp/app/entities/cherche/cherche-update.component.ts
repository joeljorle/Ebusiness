...
export class ChercheUpdateComponent implements OnInit {
  ...
  updateForm(cherche: ICherche): void {
    this.editForm.patchValue({
      ...
      createdat: cherche.createdat != null ? cherche.createdat.format(DATE_TIME_FORMAT) : null,
      updatedat: cherche.updatedat != null ? cherche.updatedat.format(DATE_TIME_FORMAT) : null
    });
  }
