...
/**
 * A DTO for the {@link com.domain.Tourgroup} entity.
 */
public class TourgroupDTO implements Serializable {
    ...
    private String filesTourgroupid;
    ...
    public String getFilesTourgroupid() {
        return filesTourgroupid;
    }

    public void setFilesTourgroupid(String filesTourgroupid) {
        this.filesTourgroupid = filesTourgroupid;
    }
    ...
    public boolean equals(Object o) {
        ...
        TourgroupDTO tourgroupDTO = (TourgroupDTO) o;
        if (tourgroupDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), tourgroupDTO.getId());
    }
    ...
    public String toString() {
        return "TourgroupDTO{" +
            ...
            ", filesId=" + getFilesId() +
            ", filesTourgroupid='" + getFilesTourgroupid() + "'" +
