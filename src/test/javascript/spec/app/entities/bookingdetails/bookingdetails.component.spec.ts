...
import { BookingdetailsComponent } from 'app/entities/bookingdetails/bookingdetails.component';
...
describe('Component Tests', () => {
  describe('Bookingdetails Management Component', () => {
    let comp: BookingdetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BookingdetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookingdetails && comp.bookingdetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
