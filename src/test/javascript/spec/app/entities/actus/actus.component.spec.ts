...
import { ActusComponent } from 'app/entities/actus/actus.component';
import { ActusService } from 'app/entities/actus/actus.service';
import { Actus } from 'app/shared/model/actus.model';

describe('Component Tests', () => {
  describe('Actus Management Component', () => {
    let comp: ActusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ActusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.actuses && comp.actuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
