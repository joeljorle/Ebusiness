...
import { RatingsComponent } from 'app/entities/ratings/ratings.component';
import { RatingsService } from 'app/entities/ratings/ratings.service';
import { Ratings } from 'app/shared/model/ratings.model';

describe('Component Tests', () => {
  describe('Ratings Management Component', () => {
    let comp: RatingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RatingsComponent, '')
        .compileComponents();
