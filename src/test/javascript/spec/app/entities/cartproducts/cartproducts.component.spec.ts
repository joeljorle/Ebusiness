...
import { CartproductsComponent } from 'app/entities/cartproducts/cartproducts.component';
...
describe('Component Tests', () => {
  describe('Cartproducts Management Component', () => {
    let comp: CartproductsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CartproductsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cartproducts && comp.cartproducts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
