...
import { ChercheComponent } from 'app/entities/cherche/cherche.component';
import { ChercheService } from 'app/entities/cherche/cherche.service';
import { Cherche } from 'app/shared/model/cherche.model';

describe('Component Tests', () => {
  describe('Cherche Management Component', () => {
    let comp: ChercheComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChercheComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cherches && comp.cherches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
