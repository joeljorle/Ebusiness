...
import { TourcategoryComponent } from 'app/entities/tourcategory/tourcategory.component';
...
describe('Component Tests', () => {
  describe('Tourcategory Management Component', () => {
    let comp: TourcategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TourcategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tourcategories && comp.tourcategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
