...
import { FollowsComponent } from 'app/entities/follows/follows.component';
import { FollowsService } from 'app/entities/follows/follows.service';
import { Follows } from 'app/shared/model/follows.model';

describe('Component Tests', () => {
  describe('Follows Management Component', () => {
    let comp: FollowsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FollowsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.follows && comp.follows[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
