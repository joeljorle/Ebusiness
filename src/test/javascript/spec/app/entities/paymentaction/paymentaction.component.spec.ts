...
import { PaymentactionComponent } from 'app/entities/paymentaction/paymentaction.component';
...
describe('Component Tests', () => {
  describe('Paymentaction Management Component', () => {
    let comp: PaymentactionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaymentactionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.paymentactions && comp.paymentactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
