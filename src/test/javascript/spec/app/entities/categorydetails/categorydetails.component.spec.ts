...
import { CategorydetailsComponent } from 'app/entities/categorydetails/categorydetails.component';
...
describe('Component Tests', () => {
  describe('Categorydetails Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategorydetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.categorydetails && comp.categorydetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
