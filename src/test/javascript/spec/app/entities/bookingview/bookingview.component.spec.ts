...
import { BookingviewComponent } from 'app/entities/bookingview/bookingview.component';
...
describe('Component Tests', () => {
  describe('Bookingview Management Component', () => {
    let comp: BookingviewComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BookingviewComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookingviews && comp.bookingviews[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
